...
GLASS = {
    ...
    "surface_alt": "#161c2c",        # поля ввода (раунд 6: серый графит, не синий)
    "surface_alt2": "#101c36",
    ...
    "card_panel": "#242a3e",         # панель карточки контроля (раунд 6: серый графит)
    "card_section": "#2a3045",       # секции внутри карточки (раунд 6)
    ...
    "completed": "#4f8cff",
    "overlay_bg": "#cc04070f",
    "hover": "#28324e",              # hover (оставлен для календаря)
    "hover_strong": "#12ffffff",
    "hover_bg": "#2c3650",           # раунд 6: hover-фон плашки строки (чуть светлее card)
    "row_alt": "#2a3247",
}
