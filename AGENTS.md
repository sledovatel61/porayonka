...
### 17.6 Результат редизайна (применён в `main`)

**Дата:** 26.07.2026  
**Коммит:** `cb57b7c fix(zonal): compact tiles, collapsible builder/summary, full Russian i18n`

Выполнен полный редизайн вкладки «Зональные»:

1. **`porayonka-app/ui/zonal/criminalist_tile.py`**
   - Плашки уменьшены до фиксированной высоты `95 px`.
   - Убран вертикальный `expand=True` у корневой колонки плашки — это устраняло гигантский пустой серый вид.
